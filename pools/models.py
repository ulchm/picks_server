...
class Pool(models.Model):
    ...
    pick_locking_type = models.IntegerField(choices=PICK_LOCKING_CHOICES, default=1)
    games_to_include = models.IntegerField(choices=GAMES_TO_INCLUDE_CHOICES, default=1)
    scoring_method = models.IntegerField(choices=SCORING_METHOD_CHOICES, default=2)
